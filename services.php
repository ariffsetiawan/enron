...
?>
	...
	<div class="content-section">
        ...
        <div class="section-tabbed section-bordered">
          <ul class="tab-nav">
           <?php
			...
			if($about[1]){
			?>
			<li class="selected"><a href="<?php echo get_permalink($service_page);?>"><?php _e( 'Our Services', 'enron' ); ?></a></li>
			<?php
			}
          ...
          <div class="tab-pane">
            ...
            <?php $postData=get_post($service_page);
		...
		?>
		 ...
		 <div class="section-services section-bordered without-border">
